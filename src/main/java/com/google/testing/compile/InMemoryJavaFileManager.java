...
final class InMemoryJavaFileManager extends ForwardingStandardJavaFileManager {
  ...
  void saveToSourcePath(Iterable<? extends JavaFileObject> files) {
    for (JavaFileObject file : files) {
      URI uri = uriForFileObject(StandardLocation.SOURCE_PATH, "", file.getName());
      inMemorySourceFiles.put(uri, file);
    }
  }
